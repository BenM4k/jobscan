...
Respond strictly in valid JSON format with no markdown wrappers and no additional commentary:
{
  ...
  "tailoredResume": "<a complete, professionally formatted tailored resume with summary, skills, and newly generated realistic bullet points tailored directly to the job description requirements>"
      ...
      if (!text) {
        return err(new AppError("EXTERNAL_API_ERROR", "Empty response received from Google Gemini API."));
      }
