...
export const EducationItemSchema = z.object({
  institution: z
    .string()
    .describe("Name of the university, college, or school"),
  degree: z
    .string()
    .describe("Degree or diploma obtained (e.g. B.S., M.S., High School)"),
  field: z.string().optional().describe("Field of study or major"),
  startDate: z
    .string()
    .optional()
    .describe("Start date (e.g. 2018 or Sep 2018)"),
...
export const ExperienceItemSchema = z.object({
  ...
  bullets: z
    .array(z.string())
    .describe("List of accomplishment / responsibility bullet points"),
});
...
export const ResumeProfileSchema = z.object({
  ...
  education: z
    ...
    .describe("List of educational credentials"),
  experience: z
...
export const JobScoreSchema = z.object({
  ...
  explanation: z
    .string()
    .optional()
    .describe("Short 1-2 sentence explanation of why this job matched"),
  matchedSkills: z
    .array(z.string())
    .describe("Skills present in both the resume and the job posting"),
  missingSkills: z
    .array(z.string())
    .describe(
      "Skills required by the job posting that are missing in the resume",
    ),
  gaps: z
    .array(z.string())
    .describe("Experience or qualification gaps identified"),
  reasoning: z
    .string()
    .describe("Detailed evaluation explanation justifying the score"),
});
...
export const TailoredResumeSchema = z.object({
  summary: z
    .string()
    .describe("Tailored professional summary emphasizing relevance to the job"),
  skills: z
    .array(z.string())
    .describe("Re-prioritized skills relevant to the job requirements"),
  experience: z
    .array(
      z.object({
        company: z.string(),
        ...
        bullets: z
          .array(z.string())
          .describe(
            "Reordered or rephrased bullets emphasizing relevance without fabrication",
          ),
      }),
    )
